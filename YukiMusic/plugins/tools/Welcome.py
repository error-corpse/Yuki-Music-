...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open(" YukiMusic/assets/WELL2.PNG")
    ...
    font = ImageFont.truetype(' YukiMusic/assets/font.ttf', size=50)
    font2 = ImageFont.truetype(' YukiMusic/assets/font.ttf', size=90)
