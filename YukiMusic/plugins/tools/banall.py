...
async def unban_all(event):
    ...
    is_admin = False
    try:
        YukiMusic = await telethn(GetParticipantRequest(event.chat_id, event.sender_id))
    except UserNotParticipantError:
        is_admin = False
    else:
        if isinstance(
            YukiMusic.participant,
...
__mod_name__ = "Pᴀʀᴀᴅᴏx"
__help__ = """
❍ /bamall ➛ ʙᴀɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs 
❍ /muteall ➛ ᴍᴜᴛᴇ ᴀʟʟ ᴍᴇᴍʙᴇʀs 
❍ /unbamall ➛ ᴜɴʙᴀɴ ᴀʟʟ ᴍᴇᴍʙᴇʀ 
